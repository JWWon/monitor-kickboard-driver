...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            logfile = open("detection_log.txt", "a")
            ...
            if pt:
                if 'Bicycle-helmet,' not in split or 'Bicycle-helmets,' not in split:
                    print("WARNING : no helmet detected.")
                    print('\a')
                
                if 'Human-faces,' in split or 'Bicycle-helmets,' in split:
                    print("WARNING : fellow rider detected.")
                    print('\a')
                    
            if onnx:
                if 'class0,' not in split or 'class0s,' not in split:
                    print("WARNING : no helmet detected.")
                    print('\a')
                
                if 'class0s,' in split or 'class1s,' in split:
                    print("WARNING : fellow rider detected.")
                    print('\a')
                
            
            _print_usage_of_cpu_and_memory()
...
def _print_usage_of_cpu_and_memory():
